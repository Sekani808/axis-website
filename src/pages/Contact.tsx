            ...
            >
              ...
              <div className="mt-8">
                ...
                <div className="flex gap-4">
                  <a
                    href="#"
                    className="w-10 h-10 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center hover:bg-axis-blue hover:text-white transition-colors"
                    aria-label="LinkedIn"
                  >
